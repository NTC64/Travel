    ...
    <div class="admin__main">
        ...
        <div class="container admincategorynews hide tb">
          ...
          ?>
                    <tr>
                        ...
                        <td><a href="delete_category.php?categoryID=<?php echo $row['categoryID'] ?>" data-id=""
                                class=""><i class="fa-solid fa-trash"></i></a></td>
                        <td><a href="#!" class="btn__editcategory" data-id="<?php echo $row['categoryID'] ?>"
        ...
        <div class="container adminnews hide tb">
            ...
            ?>
                        ...
                        <td><?php echo $date; ?></td>
                        <td><a href="#!" data-id="" class="btn__delete"><i class="fa-solid fa-trash"></i></a></td>
                        <td><a href="#!" class="btn__editnews" data-id="" data-username="" data-name=""><i
                                    class="fa-solid fa-pen-to-square"></i></a></td>
                    </tr>
                    <?php } ?>
                    <!-- end foreach -->
