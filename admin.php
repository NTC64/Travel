...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="./asset/font/fontawesome-free-6.1.2-web/css/all.min.css"
    />
  </head>
  <body>
    ...
    >
      ...
      <div class="search position-relative text-center px-4 py-3 mt-2">
        <input
          type="text"
          class="form-control w-100 border-0 bg-transparent text-white"
      ...
      <ul class="categories list-unstyled">
        ...
        <li class=""><i class="uil-setting"></i><a href="#"> Settings</a></li>
      </ul>
      <div class="logout">
        ...
        <div class="container-fluid mx-2">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"
              >admin<span class="main-color">kit</span></a
            >
          </div>
            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="uil-comments-alt"></i><span>23</span></a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#"
                  ><i class="uil-bell"></i><span>98</span></a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
