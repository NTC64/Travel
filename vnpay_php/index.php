    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <form action="./vnpay_create_payment.php" id="create_form" method="post">
                ...
                <button type="submit" name="redirect" id="rsdirect" class="btn btn-default">Thanh toán Redirect</button>
                <!-- <a href="./vnpay_create_payment.php">
                    <div class="btn btn-default" name="redirect">
                        Thanh toán Post
                    </div>
                </a> -->
            </form>
