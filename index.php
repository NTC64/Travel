            ...
            <div class="card col-4 p-0 m-2">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-black-70"><?php
                                                            ...
                                                            echo mb_substr($firstline[0], 0, 40);
            ...
            <div class="category__items row">
                ...
                <div class="card col-4 p-0 mx-3 text-center category__left" data-category='news'>
                    <img class="card-img-top"
                        src="https://th.bing.com/th/id/OIP.Eh5VUNnnLJ_eh701C5kgjwHaE8?pid=ImgDet&rs=1"
                        alt="Card image cap" />
                    <div class="card-body">
                ...
                <div class="card col-4 p-0 mx-3 text-center category__right" data-category='tour'>
                    <img class="card-img-top"
                        src="https://th.bing.com/th/id/R.9d88e3210f675be1f3f86975378aa494?rik=MV80xP7ruw5FcQ&riu=http%3a%2f%2fwww.servistur.ru%2fupload%2f6050183_xlarge.jpg&ehk=xTIkcHaDgYtR02IB1FTaEFyOPF7HC5YaRntxv2Gojlk%3d&risl=&pid=ImgRaw&r=0"
                        alt="Card image cap" />
                    <div class="card-body">
